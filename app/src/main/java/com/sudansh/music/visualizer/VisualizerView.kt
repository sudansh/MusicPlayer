package com.sudansh.music.visualizer
...
import com.sudansh.music.visualizer.data.AudioData
import com.sudansh.music.visualizer.data.FFTData
import com.sudansh.music.visualizer.renderer.Renderer
import java.util.*
 ...
 */
class VisualizerView @JvmOverloads constructor(context: Context?, attrs: AttributeSet? = null) :
    View(context, attrs) {
    ...
    init {
        ...
        fadePaint.color =
            Color.argb(238, 255, 255, 255) // Adjust alpha to change how quickly the image fades
